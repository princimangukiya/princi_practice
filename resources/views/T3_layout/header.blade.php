    ...
    <div class="container-fluid">
        <div class="d-flex">
            ...
            <div class="d-flex order-lg-2 ml-auto">
                <a data-toggle="search" class="nav-link nav-link-lg d-md-none navsearch">
                    <svg class="header-icon search-icon" x="1008" y="1248" viewBox="0 0 24 24" height="100%"
                        width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                        <path
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            <a class="dropdown-item text-center user pb-0 font-weight-bold"></a>
                            <span class="text-center user-semi-title">{{ session('c_name') }}</span>
                            <div class="dropdown-divider"></div>
                        </div>
                        @if (session('c_id') == '1')
                            <a class="dropdown-item d-flex" href="/EKLINGJI">
                                ...
                                <div class="">Eklingji Jewels</div>
                            @else
                                <a class="dropdown-item d-flex" href="/VMJEWEL">
                                    <svg class="header-icon mr-3" xmlns="http://www.w3.org/2000/svg" height="24"
                                        viewBox="0 0 24 24" width="24">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                                        <path
