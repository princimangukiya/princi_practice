<aside class="app-sidebar">
    <div class="app-sidebar__logo">
        {{-- <a class="header-brand">
            <img src="{{ asset(session('c_img_url')) }}" class="header-brand-img desktop-logo"
                alt="{{ session('c_name') }}">
            <img src="{{ asset(session('c_img_url')) }}" class="header-brand-img dark-logo"
                alt="{{ session('c_name') }}">
            <img src="{{ asset(session('c_img_url')) }}" class="header-brand-img mobile-logo"
                alt="{{ session('c_name') }}">
            <img src="{{ asset(session('c_img_url')) }}" class="header-brand-img darkmobile-logo"
                alt="{{ session('c_name') }}">
        </a> --}}
    </div>
    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            @php
                $company = trim(Session::get('dashboard'));
                
            @endphp
            <a class="side-menu__item" href="/{{ $company }}">
                ...
                <span class="side-menu__label">Dashboard</span><span
                    class="badge badge-danger side-badge">Admin</span></a>
        </li>
        <li class="slide">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                ...
                <span class="side-menu__label">Rate Master</span><i class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
                <li><a href="/weight-category" class="slide-item">Weight Category</a></li>
                <li><a href="/rate-master" class="slide-item">Rate Master</a></li>
            </ul>
        </li>
        {{-- <li class="slide">
            <a class="side-menu__item" href="/rate-master">
                ...
                <span class="side-menu__label"></span></a>
        </li> --}}
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
        ...
        {{-- <li class="slide">
            <a class="side-menu__item" href="/Inward">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                    width="24">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
                ...
                <span class="side-menu__label">Inward</span></a>
        </li>
        <li class="slide">
            <a class="side-menu__item" href="/Outward">
                <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                    width="24">
                    <path d="M0 0h24v24H0V0z" fill="none" />
                    <path
        ...
        <li class="slide">
            <a class="side-menu__item" href="/Diamond-tracker">
                ...
                <span class="side-menu__label">Diamond Tracking</span></a>
        </li>
    </ul>
</aside>
