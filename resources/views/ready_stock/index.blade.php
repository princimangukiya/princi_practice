...
<div class="page-header">
    ...
    <div class="page-rightheader">
        <div class="btn btn-list">
            <a href="{{ route('ready_stock.create') }}" class="btn btn-info"><i class="fa fa-user-plus mr-1"></i> Return Diamond From Manager  </a>
                            ...
                            <tbody>
                                @foreach ($ready_stock as $key=>$value)
                                            <tr> 
                                                ...
                                                <td>
                                                    <form action="{{ route('ready_stock.destroy', $value->r_id)}}" method="post">
                                                        @csrf
