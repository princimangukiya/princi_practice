                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="m_name" type="text" name="m_name" class="form-control" value="{{ $manager->m_name }}" placeholder="Enter Manager Name">
                            @error('m_name')
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="m_address" type="text" name="m_address" class="form-control" value="{{ $manager->m_address }}" placeholder="Enter Manager Address" required>
                            @error('m_address')
                                <small class="errorTxt1">
                                    <div id="title-error" class="error" style="margin-left:3rem">
                                        {{ $message }}
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input placeholder="Enter Manager Phone No." class="form-control" id="m_phone" type="text" name="m_phone"  value="{{ $manager->m_phone }}"  required>
                            @error('m_phone')
                            <small class="errorTxt1">
                                <div id="title-error" class="error" style="margin-left:3rem">
                                    {{ $message }}
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <input placeholder="Enter Manager Email Id" class="form-control" id="m_email" type="text" name="m_email"  value="{{ $manager->m_email }}"  required>
                            @error('m_email')
                            <small class="errorTxt1">
                                <div id="title-error" class="error" style="margin-left:3rem">
                                    {{ $message }}
