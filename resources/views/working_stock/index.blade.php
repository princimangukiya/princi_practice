...
<div class="page-header">
    ...
    <div class="page-rightheader">
        <div class="btn btn-list">
            <a href="{{ route('working_stock.create') }}" class="btn btn-info"><i class="fa fa-user-plus mr-1"></i> Give Diamond To Manager  </a>
                            ...
                            <tbody>
                                @foreach ($working_stock as $key=>$value)
                                            <tr> 
                                                ...
                                                <td>
                                                    <form action="{{ route('working_stock.destroy', $value->w_id)}}" method="post">
                                                        @csrf
