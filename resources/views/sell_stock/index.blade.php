 ...
 @section('content')
     <div class="page-header">
         <div class="page-leftheader">
             ...
             <ol class="breadcrumb">
                 <li class="breadcrumb-item"><a href=""><i class="fe fe-layout mr-2 fs-14"></i>Sell Stock</a></li>
                                                 ...
                                                 <td class="align-middle"
                                                     ...
                                                     <div class="btn-group align-top">
                                                         <button class="btn btn-sm btn-danger diaDeleteBtn"
                                                             ...
                                                             data-href="{{ route('sell_stock.destroy', $value->sell_id) }}">Delete
