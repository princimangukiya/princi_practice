            ...
            <div class="card-body">
                <div class="d-flex align-items-end justify-content-between">
                    <div>
                        ...
                        <h2 class="mb-0"><span class="number-font1"></span>{{ $totalSupplier }}<span class="ml-2 text-muted fs-11"><span class="text-success"><i class="fa fa-caret-up"></i></span></span></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-end justify-content-between">
                    <div>
                        ...
                        <h2 class="mb-0"><span class="number-font1"> </span>{{ $totalWorkingStock }}</h2>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-end justify-content-between">
                    <div>
                        ...
                        <h2 class="mb-0"><span class="number-font1"></span>{{ $totalSellStock }}<span class="ml-2 text-muted fs-11"><span class="text-success"><i class="fa fa-caret-up"></i></span></span></h2>
                    </div>
                    <span class="text-secondary fs-35 dash1-iocns bg-secondary-transparent border-secondary"><i class="las la-hand-holding-usd"></i></span>
                </div>
                <div class="d-flex mt-4">
